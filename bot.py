...
NT_BEARER  = os.getenv("NT_BEARER",  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoyNjU4NDc0LCJhcHBfaWQiOiIxNzcwOTgxMzQ3IiwiZGV2aWNlX2lkIjoiYjVkMmMxMmUtZTVjZC00OWIwLThlZTItNGM2MzA0NGYwMGE1IiwicGxhdGZvcm0iOiIzIiwidXNlcl90eXBlIjoxLCJpYXQiOjE3Nzg3NzAxMjksImV4cCI6MTc4MTM2MjEyOX0.hggVfi2_m3WKWUHxE6CCGD9Q5waLOhdb4y4Btj1ySvw")

MJ_APP_ID  = os.getenv("MJ_APP_ID",  "1772100600")
MJ_USER_ID = os.getenv("MJ_USER_ID", "3186295")
MJ_BEARER  = os.getenv("MJ_BEARER",  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjozMjQ1MDMzLCJhcHBfaWQiOiIxNzcyMTAwNjAwIiwiZGV2aWNlX2lkIjoiYjVkMmMxMmUtZTVjZC00OWIwLThlZTItNGM2MzA0NGYwMGE1IiwicGxhdGZvcm0iOiIzIiwidXNlcl90eXBlIjoxLCJpYXQiOjE3Nzg3NzAxMzQsImV4cCI6MTc4MTM2MjEzNH0.oFHSTWzd3-HbVQ3MXPpush-nuAj-MpcCK3t86p_6mrg")
